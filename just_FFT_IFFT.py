...
from functions import read_wav, add_zeros,resamplingAudio
import numpy as np
import matplotlib.pyplot as plt
from copy import deepcopy

sound_array, fs = read_wav('D:\\Audio_files\\drone_motor.wav', mmap=True)
n, sound_array = add_zeros(sound_array, degree=12)  # where n = 2^degree

sound_array = resamplingAudio(audio=sound_array, fs=fs, new_fs=44100)
